...
cars2$engine_fuel_type <- str_replace_all(cars2$engine_fuel_type, c(
...
format(metrics_galore(test$logmsrp, simple.test), scientific = FALSE)
...
format(metrics_galore(valid$logmsrp, simple.valid), scientific = FALSE)
