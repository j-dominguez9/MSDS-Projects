...
6 total. All except popularity (and maybe year) need to be transformed in some way. Popularity could be categorical and set as factor bc each car's make shares the same value
