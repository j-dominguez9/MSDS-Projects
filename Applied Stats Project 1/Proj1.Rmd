...
tree3 <- rpart(msrp ~. -logmsrp, data = train, method = 'anova',
                    control = rpart.control(minbucket = 100))
...
#model 4 with caret all variables - performs worse but less risk of overfitting
trctrl <- trainControl(method = 'repeatedcv', repeats = 3, number = 10)
tree4 <- train(msrp ~ . -logmsrp, data = train, method = "rpart2")
