...
reg.fwd=regsubsets(logmsrp~popularity+year+engine_hp+highway_mpg+engine_fuel_type+vehicle_size, data=train, method="forward",nvmax=6)
...
par(mfrow=c(1,1))
plot(1:6,testASE,type="l",xlab="# of predictors",ylab="test vs train ASE",ylim=c(10, 100))
index<-which(testASE==min(testASE))
points(index,testASE[index],col="red",pch=10)
rss<-summary(reg.fwd)$rss
lines(1:6,rss/100,lty=3,col="blue")
```
Assumptions check
```{r}
